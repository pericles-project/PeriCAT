 ...
 */
/**
 * This package contains the classes for the distance calculations between
 * algorithms and scenarios, and the classes related to the decision making on
 * which algorithm to use for a scenario.
 */
